								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-body">
											...
											<form class="g-3 " action="<?php echo base_url(); ?>/storerole" method="post" id="adduserform">
											<div id="wizard1">
													...
													<div class="col-lg-4">
													  ...
													  <input type="text" class="form-control" id="role_name" name="role_name" placeholder="Name" required value="<?= set_value('role_name');?>">
