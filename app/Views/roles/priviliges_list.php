					...
					<div class="app-sidebar">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="upcoming_trips.php">
...
<path d="M12 6.5C13.1046 6.5 14 5.60457 14 4.5C14 3.39543 13.1046 2.5 12 2.5C10.8954 2.5 10 3.39543 10 4.5C10 5.60457 10.8954 6.5 12 6.5Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
									...
									<ul class="slide-menu">
                                        <li><a href="batches.php" class="slide-item">Batches	</a></li>
                                        <li><a href="all_treks.php" class="slide-item">All Treks	</a></li>
										<li><a href="treks_reviews.php" class="slide-item">Reviews</a></li>
										<li><a href="transactions.php" class="slide-item">Transaction Details	</a></li>
									</ul>
								</li>
								...
								<li class="slide">
									...
									<ul class="slide-menu">
                                        <li><a href="batches.php" class="slide-item">Batches	</a></li>
                                        <li><a href="all_trips.php" class="slide-item">All Trips	</a></li>
										<li><a href="treks_reviews.php" class="slide-item">Reviews</a></li>
										<li><a href="transactions.php" class="slide-item">Transaction Details	</a></li>
									</ul>
								</li>
								...
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="enquiries.php">
								...
								<li class="slide">
									...
									<ul class="slide-menu">
                                        <li><a href="contacts.php" class="slide-item">Contacts</a></li>
										<li><a href="templates.php" class="slide-item">Templates</a></li>
										<li><a href="manage_campaign.php" class="slide-item">Manage Campaign</a></li>
									</ul>
								</li>
								<li class="slide">
									<a class="side-menu__item has-link" data-bs-toggle="slide" href="items.php">
								...
								<li class="slide">
									...
									<ul class="slide-menu">
                                        <li><a href="admin_users.php" class="slide-item">Admin Users</a></li>
										<li><a href="customers.php" class="slide-item">Customers</a></li>
										<li><a href="roles.php" class="slide-item">Roles</a></li>
										<li><a href="privileges.php" class="slide-item">Privileges</a></li>
									</ul>
								</li>
								<!-- <li class="slide">
 ...
 -->
				...
				<!--/APP-SIDEBAR--><style type="text/css">
	.p-l-30 {
          ...
          accent-color: green;
				...
				<div class="app-content main-content mt-0">
									...
									<div class="card product-sales-main">
										<div class="card-body">
											<div aria-multiselectable="true" class="accordion" id="accordion" role="tablist">
												<div id="alert_message" style="color: #fff;background-color: green;border: 1px solid green; text-align: center;opacity: 0.5;"></div>
												<form method="post" action="<?php echo base_url();?>/rolepriviliesstore">
                  <table class="table" id="myTable">
                    ...
                    <tbody>
                    	<?php //echo "<pre>"; print_r($previliges);

                    	//exit;$previliges['add_priviliges']
	$previliges['access_priviliges'] = explode(",",$previliges['access_priviliges']);
	$previliges['add_priviliges'] 	 = explode(",",$previliges['add_priviliges']);
	$previliges['edit_priviliges'] = explode(",",$previliges['edit_priviliges']);
	$previliges['delete_priviliges'] = explode(",",$previliges['delete_priviliges']);
	$previliges['status_priviliges'] = explode(",",$previliges['status_priviliges']);
                    	foreach($modules as $k=> $module){ 
                    		if($module['parent_id']==0){
                    			$parent[$module['parent_id']][$module['module_id']]['module_id'] = $module['module_id'];
                    			$parent[$module['parent_id']][$module['module_id']]['module_name']= $module['module_name'];
                    		}else{
                    			$mod[$module['parent_id']][$module['module_id']]['module_id'] = $module['module_id'];
                    			$mod[$module['parent_id']][$module['module_id']]['module_name']= $module['module_name'];
                    		}
                    	}                    	
                    	foreach($parent[0] as $m){ ?>
                		<tr>
                        <td><a aria-controls="collapseOne" aria-expanded="true" data-bs-toggle="collapse" href="#collapseOne<?php echo $m['module_id'];?>"><strong class="text-primary"><i class="icon-plus text-primary"></i>&nbsp; <?php echo $m['module_name']?></strong></a></td>
                        <td id="td_access<?php echo $m['module_id'];?>">
                        	<?php if(!empty($previliges['access_priviliges']) && (in_array($m['module_id'],$previliges['access_priviliges']))) { ?>
						  <a  onclick="changePreviliges('access<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id'];?>,'n','access')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('access<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id']?>,'y','access')"><i class="fa fa-close text-danger"></i> </a><?php } ?>
                        </td>
                        <td id="td_add<?php echo $m['module_id'];?>">


                        	<?php if(!empty($previliges['add_priviliges']) && (in_array($m['module_id'],$previliges['add_priviliges']))) { ?>
						  <a  onclick="changePreviliges('add<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id'];?>,'n','add')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('add<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id']?>,'y','add')"><i class="fa fa-close text-danger"></i> </a><?php } ?>




                        </td>
                        <td id="td_edit<?php echo $m['module_id'];?>">



                        	<?php if(!empty($previliges['edit_priviliges']) && (in_array($m['module_id'],$previliges['edit_priviliges']))) { ?>
						  <a  onclick="changePreviliges('edit<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id'];?>,'n','edit')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('edit<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id']?>,'y','edit')"><i class="fa fa-close text-danger"></i> </a><?php } ?>


                        </td>
                        <td id="td_delete<?php echo $m['module_id'];?>">


                        	<?php if(!empty($previliges['delete_priviliges']) && (in_array($m['module_id'],$previliges['delete_priviliges']))) { ?>
						  <a  onclick="changePreviliges('delete<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id'];?>,'n','delete')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('delete<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id']?>,'y','delete')"><i class="fa fa-close text-danger"></i> </a><?php } ?>


                        </td>
                        <td id="td_status<?php echo $m['module_id'];?>">


                        	<?php if(!empty($previliges['status_priviliges']) && (in_array($m['module_id'],$previliges['status_priviliges']))) { ?>
						  <a  onclick="changePreviliges('status<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id'];?>,'n','status')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('status<?php echo $m['module_id'];?>',<?php echo $role_id;?>,<?php echo $m['module_id']?>,'y','status')"><i class="fa fa-close text-danger"></i> </a><?php } ?>
                      ...
                      <tr>
                        <td colspan="6" class="p-0"><div aria-labelledby="headingOne" class="collapse" data-bs-parent="#accordion" id="collapseOne<?php echo $m['module_id'];?>" role="tabpanel">
                            <table class="table" style="background-color: rgb(188 188 188 / 10%)">
                              <tbody>
                              	<?php foreach($mod[$m['module_id']] as $k=>$mchild){ 
                    	 	
                    	 	?>
                                <tr>
                                  <td style="width:25%" class="p-l-30"><i class="fa fa-angle-double-right"></i> <?php echo $mchild['module_name'] ?></td>
                                  <td style="width:15%" id="td_access<?php echo $mchild['module_id'];?>">

                                  	<?php if(!empty($previliges['access_priviliges']) && (in_array($mchild['module_id'],$previliges['access_priviliges']))) { ?>
						  <a  onclick="changePreviliges('access<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id'];?>,'n','access')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('access<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id']?>,'y','access')"><i class="fa fa-close text-danger"></i> </a><?php } ?>

                                  </td>
                                  <td style="width:15%" id="td_add<?php echo $mchild['module_id'];?>">

							<?php if(!empty($previliges['add_priviliges']) && (in_array($mchild['module_id'],$previliges['add_priviliges']))) { ?>
						  <a  onclick="changePreviliges('add<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id'];?>,'n','add')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('add<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id']?>,'y','add')"><i class="fa fa-close text-danger"></i> </a><?php } ?>
                                  ...
                                  <td style="width:15%" id="td_edit<?php echo $mchild['module_id'];?>">

<?php if(!empty($previliges['edit_priviliges']) && (in_array($mchild['module_id'],$previliges['edit_priviliges']))) { ?>
						  <a  onclick="changePreviliges('edit<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id'];?>,'n','edit')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('edit<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id']?>,'y','edit')"><i class="fa fa-close text-danger"></i> </a><?php } ?>

                                  	


                                  </td>
                                  <td style="width:15%" id="td_delete<?php echo $mchild['module_id'];?>">

<?php if(!empty($previliges['delete_priviliges']) && (in_array($mchild['module_id'],$previliges['delete_priviliges']))) { ?>
						  <a  onclick="changePreviliges('delete<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id'];?>,'n','delete')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('delete<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id']?>,'y','delete')"><i class="fa fa-close text-danger"></i> </a><?php } ?>
                                  	

                                  </td>
                                  <td style="width:15%" id="td_status<?php echo $mchild['module_id'];?>">

                                  	<?php if(!empty($previliges['status_priviliges']) && (in_array($mchild['module_id'],$previliges['status_priviliges']))) { ?>
						  <a  onclick="changePreviliges('status<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id'];?>,'n','status')"><i class="fa fa-check"></i> </a>
						  <?php } else { ?>
						  <a  onclick="changePreviliges('status<?php echo $mchild['module_id'];?>',<?php echo $role_id;?>,<?php echo $mchild['module_id']?>,'y','status')"><i class="fa fa-close text-danger"></i> </a><?php } ?>
				...
				<div class="container">
					<div class="row align-items-center flex-row-reverse">
						<div class="col-md-12 col-sm-12 text-center">
							Copyright © 2022 <a href="#">Ridingsolo</a> All rights reserved
						</div>
					</div>
				</div>
			</footer>
...
var id2= $.trim(id);
var status2 = (status=='y')?'n':'y';
var icon = (status=='y')?'fa fa-check':'fa fa-close text-danger';

   $.ajax({
   method: "POST",            
   url: "<?php echo base_url(); ?>/rolepriviliesstore",
   ...
   success: function(data) {        
       ...
       var resultdata = $.parseJSON(data);
        ...
        $('#td_'+id).html('<a style="color:red" onclick="changePreviliges(\''+id2+'\',\''+role_id+'\',\''+module_id+'\',\''+status2+'\',\''+previliges+'\')"><i class="'+icon+'"></i> </a>');
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h5 class="modal-title">ADD/Edit Question </h5><button aria-label="Close" class="btn-close" data-bs-dismiss="modal" ><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
						...
						<form class="form-horizontal">
							...
							<div class="form-group">
								...
								<option value="1" selected="">Treks</option>
								<option value="2">Bike Trips</option>
								<option value="3">Leisure Trips</option>
								<option value="4">Expedition</option>
							</select>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Answer</label>
								<textarea type="textarea" class="form-control" rows="7">We RidingSolo, a travel adventure company, are a one-stop solution for backpackers and travelers, with a wide range of treks, Bike Trips, Expedition, cancellations, and customized co-travelable. RidingSolo has been operational since 2015. The eminent travel adventure company is registered with IMF (Indian Mountaineering Foundation), Himachal Pradesh, and Uttarakhand Government. RidingSolo is also a registered partner of à¤…à¤¤à¥à¤²à¥à¤¯ à¤­à¤¾à¤°à¤¤ (Incredible India). With an overall rating of 4.8 on Google and TripAdvisor, our feedback and attention towards our clients have been consistently excellent.</textarea>
							</div>
